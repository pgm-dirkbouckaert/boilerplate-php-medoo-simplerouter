...
// Source: https://github.com/steampixel/simplePHPRouter
...
class Router {
  ...
  public static function run($basepath = '', $case_matters = false, $trailing_slash_matters = false, $multimatch = false) {
    ...
    // Returns an array containing the parts of the URL: host, path, query, ...
    ...
    // Decodes special chartacter sequences (e.g. percent encoding like %20, %21, ... see also: https://www.urldecoder.net/)
    $path = urldecode($path);
